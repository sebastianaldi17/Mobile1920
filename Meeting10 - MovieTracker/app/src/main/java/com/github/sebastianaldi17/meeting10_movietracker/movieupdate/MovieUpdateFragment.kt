...
import com.github.sebastianaldi17.meeting10_movietracker.databinding.FragmentMovieUpdateBinding
        ...
        movieUpdateViewModel.navigateToMovieTracker.observe(this, Observer {
            status -> status?.let {
                when (status) {
                    ...
                    "movieNotFound" -> Toast.makeText(this.context, "There isn no movie with that key.", Toast.LENGTH_SHORT).show()
                }
            }
        })
